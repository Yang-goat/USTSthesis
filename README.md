...
本模板面向苏州科技大学数学科学学院本科毕业设计（论文）写作，当前 `2.2.1` 版本在三文档架构基础上改用 Word 封面转 PDF 插入，补充毕业论文/毕业设计页眉选择、附录 C 代码清单、参考文献多类型示例与本地格式来源文件，并修正定理类环境和交叉引用的斜体问题，可同时支持：
...
- 定理、引理、命题、推论、定义和证明的标题保持黑体加粗，正文统一使用正体。
- 图、表、公式、算法和定理类交叉引用显式使用正体，避免编号继承斜体上下文。
- 数学公式中的变量仍按数学排版规则使用斜体。
...
大多数位置不需要手动设置字体，模板已经为章节标题、目录、摘要标题、关键词、图表标题和定理标题配置好字体。定理、引理、命题、推论、定义和证明的正文统一使用正体；公式中的数学变量仍按数学排版规则使用斜体，环境内的交叉引用编号不会被整体变为斜体。
...
| **2.2.1** | 2026-06-08 | 修正定理、定义与证明等环境的正文斜体问题，并确保图表、公式、算法及定理类交叉引用编号保持正体。 |
